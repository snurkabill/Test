...
public final class MercurialPreferenceConstants {
	...
	public static final String PREF_SHOW_GRAPH = "pref_show_graph"; //$NON-NLS-1$
	...
	public static final String PREF_SHOW_PUSH_FORCE_GUIDANCE_DIALOG = "hg.showPushForceGuidanceDialog";
