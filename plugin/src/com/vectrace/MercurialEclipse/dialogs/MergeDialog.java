...
public class MergeDialog extends CommitDialog {
	...
	protected CommitFilesChooser createFilesList(Composite container) {
		SWTWidgetHelper.createLabel(container, Messages.getString("CommitDialog.selectFiles.selectable")); //$NON-NLS-1$
	...
	protected void performCommit(String message, boolean closeBranch, boolean amend)
		...
		CommitMergeHandler.commitMerge(root, getUser(), message);
	}
}
