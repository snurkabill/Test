...
public class HgIncomingClient extends AbstractParseChangesetClient {
	...
	public static Map<IPath, SortedSet<ChangeSet>> getHgIncoming(IResource res, HgRepositoryLocation repository, String branch) throws HgException {
		...
		try {
			...
			try {
				...
				Map<IPath, SortedSet<ChangeSet>> revisions = createMercurialRevisions(res, result, true, Direction.INCOMING, repository, bundleFile, new IFilePatch[0]);
				return revisions;
