...
public class HgTagClient {
	 ...
	 * @param resource
	 * @param name
	 * @param user if null, uses the default user
	 * @param local
	 * @throws HgException
	 */
	public static void addTag(IResource resource, String name, String user, boolean local) throws HgException {
		HgCommand command = new HgCommand("tags", resource.getProject(), false);
		if(local) {
