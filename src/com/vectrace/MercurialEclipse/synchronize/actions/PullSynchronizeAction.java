...
public class PullSynchronizeAction extends SynchronizeModelAction {
    ...
    public PullSynchronizeAction(String text,
	...
	public PullSynchronizeAction(String text,
			ISynchronizePageConfiguration configuration,
			ISelectionProvider selectionProvider, boolean update) {
	...
	protected SynchronizeModelOperation getSubscriberOperation(
		...
		return new PullRepositorySynchronizeOperation(configuration, elements,
				resources, update);
	}	
}
