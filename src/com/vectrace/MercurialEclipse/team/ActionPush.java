 ...
 *
 */
public class ActionPush implements IWorkbenchWindowActionDelegate 
{
...
//    private IWorkbenchPart targetPart;
  ...
  {
//    System.out.println("ActionPush:init(window)");
    this.window = window;
  }
  ...
  public void run(IAction action) 
  {
    ...
    pushRepoWizard.init(workbench, selection);
    
    WizardDialog pushWizardDialog = new WizardDialog(shell,pushRepoWizard);
//    pushWizardDialog.setBlockOnOpen(true); 
