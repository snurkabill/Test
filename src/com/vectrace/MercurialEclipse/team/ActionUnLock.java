...
import com.vectrace.MercurialEclipse.menu.UnLockHandler;

public class ActionUnLock implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		if (selection.getFirstElement() instanceof IResource) {
			...
			try {
				new UnLockHandler().run(firstElement);
			} catch (HgException e) {
