...
import com.vectrace.MercurialEclipse.menu.LockHandler;

public class ActionLock implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		if (selection.getFirstElement() instanceof IResource) {
			...
			try {
				new LockHandler().run(firstElement);
			} catch (HgException e) {
